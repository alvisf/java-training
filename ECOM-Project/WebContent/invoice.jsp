...
<div class="row justify-content-center">
	...
	<div class="col-auto"><input class="btn btn-info" type="submit" value="Send SMS"></div></form>
	<form action="excel.do" method="post">
	<input type="hidden" name="formid" value="excel">
	<div class="col-auto"><input class="btn btn-info" type="submit" value="Create Excel"></div></form>
	<form action="email.do" method="post">
	<input type="hidden" name="formid" value="email">
	<div class="col-auto"><input class="btn btn-info" type="submit" value="Send Email"></div></form>
	<form action="pdf.do" method="post">
	<input type="hidden" name="formid" value="pdf">
	<div class="col-auto"><input class="btn btn-info" type="submit" value="Create PDF"></div></form>
	</div>
</div>
</body>
</html>